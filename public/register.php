...
<body class="gradient-bg min-h-screen flex items-center justify-center py-12 font-sans antialiased relative overflow-hidden">
    ...
    <div class="max-w-md w-full mx-4 relative z-10">
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/50 animate-fade-in-up stagger-2">
            ...
            <form action="<?php echo defined('BASE_PATH') ? BASE_PATH : ''; ?>/actions/auth/register.php" method="POST" class="space-y-5">
                <?php if ($redirect): ?>
                ...
                <div class="animate-fade-in-up stagger-3">
                    ...
                    <div class="relative group">
                        ...
                        >
                        <i class="fas fa-user absolute left-4 top-4 text-gray-400 transition-colors duration-200 group-focus-within:text-primary"></i>
                    </div>
                </div>
                ...
                <div class="animate-fade-in-up stagger-5">
                    ...
                    <div class="relative group">
                        ...
                        <button type="button" onclick="togglePassword('password', 'togglePasswordIcon')" class="absolute right-4 top-4 text-gray-400 hover:text-primary transition-colors duration-200 focus:outline-none">
                            <i id="togglePasswordIcon" class="fas fa-eye"></i>
                        </button>
                    </div>
                    <p class="mt-1 text-xs text-gray-500">Must contain uppercase, lowercase, and a number</p>
                </div>
                ...
                <div class="animate-fade-in-up stagger-6">
                    ...
                    <div class="relative group">
                        ...
                        >
                        <i class="fas fa-shield-alt absolute left-4 top-4 text-gray-400 transition-colors duration-200 group-focus-within:text-primary"></i>
                        <button type="button" onclick="togglePassword('confirm_password', 'toggleConfirmPasswordIcon')" class="absolute right-4 top-4 text-gray-400 hover:text-primary transition-colors duration-200 focus:outline-none">
                ...
                <!-- Terms -->
                <div class="flex items-start animate-fade-in stagger-7">
        ...
        <!-- Back to Home -->
        <div class="text-center mt-6 animate-fade-in" style="animation-delay: 0.55s;">
